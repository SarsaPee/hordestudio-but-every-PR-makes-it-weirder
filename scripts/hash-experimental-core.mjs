...
if (paths.some(path => !path.startsWith('experiences/experimental-worlds/') || /(?:adapter|migration|test|docs|packaging)/.test(path))) {
  throw new Error('manifest contains an excluded or non-core path');
}
