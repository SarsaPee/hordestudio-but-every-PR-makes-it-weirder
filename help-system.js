(function () {
    ...
    const HELP_BY_ID = Object.freeze({
        ...
        'cs-tts-mode': 'Choose browser speech or neural TTS. Neural TTS uses the separately configured provider, model, voice and format.',
        ...
        'global-api-provider': 'Default provider for text models. Individual Worlds and Virtual Humans may override text, image and voice independently.',
        ...
        'global-bedrock-region': 'AWS region used to construct the Bedrock Mantle endpoint, such as us-east-1.',
