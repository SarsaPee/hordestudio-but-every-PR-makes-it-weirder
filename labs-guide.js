(function () {
    ...
    const rawEntries = [
        ...
        ['labs_models', 'Labs model sizes', 'embedded tiny brain smollm 135m micro small tier download webgpu wasm contact gate memory continuity', 'The Embedded Tiny Brain is SmolLM2 135M stored in the browser cache and run with WebGPU or WASM. It is used only for narrow evidence-grounded classifications such as contact appropriateness, social signals and memory gating—not final roleplay writing or canonical life simulation. Malformed or low-confidence output falls back to the deterministic kernel. Larger connected local models unlock tasks whose capability floor is Small or Extended.'],
