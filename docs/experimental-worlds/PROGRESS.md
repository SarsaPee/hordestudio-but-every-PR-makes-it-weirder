...
- [~] Repeat the full browser proof after the Milestone A checkpoint. The staged 17.4 F16 portrait save/reload/clear/reload, F18 graduation/save/readback, F19/F20 relationship save/readback, F09 Location graduation, same-Day reroll safety, and cross-mode deletion/readback now passed with a mocked provider or provider-independent browser run as applicable. Cross-origin late-response isolation passed with the mock; same-tab late-response switching and the complete dual-17.0 checkpoint remain before promotion.
