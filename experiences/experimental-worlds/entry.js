...
async function render() {
    ...
    root.querySelector('[data-experimental-action="disable"]')?.addEventListener('click', async () => { await runtime.host.updateSettings({ experimentalWorlds: { enabled: false, acknowledgementVersion: 0 } }); runtime.host.notify('Experimental Worlds is off and will require acknowledgement before it can be enabled again. Saved Experimental Worlds were not changed.', 'info'); await render(); });
