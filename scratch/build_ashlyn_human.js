...
const companion = {
    ...
    startingSocialPosts: [
        ...
        { id: 'ash_social_02', kind: 'photo', category: 'work_school', text: 'campus is pretty when it is not actively ruining my life', scene: 'Sunny campus walkway selfie with backpack and casual fitted tee between classes.', photo: 'assets/bundled/ashlyn-social/02.jpg', seedAgeDays: 64, source: 'manual' },
        { id: 'ash_social_03', kind: 'photo', category: 'work_school', text: 'if i hand you the right drink before you order it i deserve a raise actually', scene: 'Coworker-taken coffee-shop snapshot in black tee and apron behind the counter.', photo: 'assets/bundled/ashlyn-social/03.jpg', seedAgeDays: 53, source: 'manual' },
        { id: 'ash_social_04', kind: 'photo', category: 'fitness', text: 'showed up. that is the caption.', scene: 'Gym mirror selfie in a fitted black athletic set after a workout.', photo: 'assets/bundled/ashlyn-social/04.jpg', seedAgeDays: 41, source: 'manual' },
        ...
        { id: 'ash_social_05', kind: 'photo', category: 'friends', text: 'brunch meeting (we discussed nothing)', scene: 'Brunch table photo with iced coffees and a close female friend.', photo: 'assets/bundled/ashlyn-social/05.jpg', seedAgeDays: 33, source: 'manual' },
        { id: 'ash_social_06', kind: 'photo', category: 'fashion', text: 'the one day la weather and i are on speaking terms', scene: 'Sunny Santa Monica boardwalk selfie in a loose white linen shirt.', photo: 'assets/bundled/ashlyn-social/06.jpg', seedAgeDays: 24, source: 'manual' },
        { id: 'ash_social_07', kind: 'photo', category: 'fashion', text: 'said i was staying in and then this happened', scene: 'Night-out mirror selfie in a stylish dark fitted top, short skirt and heels.', photo: 'assets/bundled/ashlyn-social/07.jpg', seedAgeDays: 16, source: 'manual' },
        ...
        { id: 'ash_social_11', kind: 'photo', category: 'thirst_traps', text: 'office hours were moved to the beach sorry', scene: 'Bright candid full-body beach photo in a colorful bikini near the Santa Monica pier, laughing in the wind, playful public thirst trap.', photo: 'assets/bundled/ashlyn-social/11.jpg', seedAgeDays: 13, source: 'manual' },
        { id: 'ash_social_08', kind: 'photo', category: 'everyday', text: 'do not ask me what time i finally went to sleep', scene: 'Messy late-night dorm selfie in an oversized hoodie with tired natural makeup.', photo: 'assets/bundled/ashlyn-social/08.jpg', seedAgeDays: 9, source: 'manual' },
        ...
        { id: 'ash_social_12', kind: 'photo', category: 'thirst_traps', text: 'community service but make it productive', scene: 'Playful close front-camera car-wash selfie in a white bikini top and denim shorts, wet hair, sun flare and soap suds.', photo: 'assets/bundled/ashlyn-social/12.jpg', seedAgeDays: 7, source: 'manual' },
        { id: 'ash_social_13', kind: 'photo', category: 'thirst_traps', text: 'academically present', scene: 'Playful full-body dorm mirror selfie in a fitted USC crop top, denim shorts and sneakers, tongue out and peace sign, casual public thirst trap.', photo: 'assets/bundled/ashlyn-social/13.jpg', seedAgeDays: 6, source: 'manual' },
        { id: 'ash_social_09', kind: 'photo', category: 'friends', text: 'passenger princess duties are extremely demanding', scene: 'Passenger-seat road-trip selfie in sunglasses and seatbelt.', photo: 'assets/bundled/ashlyn-social/09.jpg', seedAgeDays: 5, source: 'manual' },
        { id: 'ash_social_14', kind: 'photo', category: 'boudoir', text: 'five more minutes became an hour', scene: 'Close phone selfie reclining in her dorm bed in a blush satin camisole, warm lamp light and an unmade bed, intimate but non-nude.', photo: 'assets/bundled/ashlyn-social/14.jpg', seedAgeDays: 4, source: 'manual' },
        { id: 'ash_social_15', kind: 'photo', category: 'swimwear', text: 'chlorine is basically skincare right', scene: 'Bright poolside photo in a neon green bikini, kneeling in the shallow water and looking back toward the camera.', photo: 'assets/bundled/ashlyn-social/15.jpg', seedAgeDays: 3, source: 'manual' },
        { id: 'ash_social_10', kind: 'photo', category: 'everyday', text: 'sunday reset except the laundry and the assignment are both winning', scene: 'Quiet Sunday study-table photo with laptop and laundry in the background.', photo: 'assets/bundled/ashlyn-social/10.jpg', seedAgeDays: 2, source: 'manual' },
